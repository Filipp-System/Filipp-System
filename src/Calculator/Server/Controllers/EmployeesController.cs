...
//                var concurrencyResult = new CalculationConcurrencyResolver
//                {
...
//        /// <param name="id">The id of the <see cref="Employee"/>.</param>
//        /// <param name="value">The <see cref="CalculationConcurrencyResolver"/> payload.</param>
//        /// <returns>An <see cref="IActionResult"/> of OK or Conflict.</returns>
//        [HttpPut("{id}")]
//        public async Task<IActionResult> PutAsync(int id, [FromBody] CalculationConcurrencyResolver value)
//        {
